...
public class AllMethodMouseAdapter extends MouseAdapter {
    ...
    public AllMethodMouseAdapter(JarAnalyzerForm jarAnalyzerForm) {
        this.form = jarAnalyzerForm;
    }
    ...
    public void mousePressed(MouseEvent evt) {
        ...
        if (SwingUtilities.isRightMouseButton(evt) || evt.isControlDown()) {
            ...
            JarAnalyzerForm.chainDataList.addElement(
                    new ResObj(res.getMethod(), res.getClassName()));
    ...
    public void mouseClicked(MouseEvent evt) {
        ...
        if (evt.getClickCount() == 1) {
            ...
            new Thread(() -> {
                String total;
                JarAnalyzerForm.historyDataList.addElement(
                        new ResObj(res.getMethod(), res.getClassName()));
